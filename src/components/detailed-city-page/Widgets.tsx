...
const Widgets = () => {
  ...
  <div className="details-item">
    ...
    <div className="details-item-text">По ощущениям <br />примерно так-же</div>
  </div>
  <div className="details-item">
    <div className="details-item-title">
    ...
    <div className="details-item-main">
      <div className="compass-wrapper">
        <img
          ...
          alt=""
        />
        <img src="img/images-details/compas-big/Polygon 1.svg" alt="" className="compass-top" />
        <img
        ...
        <div className="compass-text">2<br />км/ч</div>
  ...
  <div className="details-item">
    ...
    <div className="details-item-main">
      <div className="uv-index-wrapper">
        <div className="uv-index-text">0 <br />Низкий</div>
    ...
    <div className="details-item-main">
      <div className="pressure-wrapper">
        ...
        <div className="pressure-arrow-wrapper">
          <img src="img/images-details/pressure/Arrow.svg" alt="" className="pressure-arrow" />
        </div>
      </div>
    </div>
    <div className="details-item-text">1117 <br />гПа</div>
  </div>
  <div className="details-item">
    <div className="details-item-title">
      <div>
