...
const CityPage = () => {
  return (
    <div className='mx-[80px] flex flex-col items-center text-white'>
      <Searchbar />
      <div className=" w-full flex justify-between items-end py-24 px-24 rounded-primary font-Mulish relative bg-[url('/src/components/img/location-bg.png')] mb-20">
        <div className='bg-blured-grey backdrop-blur-sm rounded-primary py-8 px-14 font-light text-8xl leading-[120px]'>
          ...
          <div className='font-medium text-[40px] leading-[50px]'>Переменная облачность</div>
        </div>
